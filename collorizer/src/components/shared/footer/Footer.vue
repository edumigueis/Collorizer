<template>
  <footer>
    <svg xmlns="http://www.w3.org/2000/svg" id="waves" viewBox="0 0 1440 320">
      <path
        fill="#131313"
        fill-opacity="1"
        d="M0,96L26.7,96C53.3,96,107,96,160,90.7C213.3,85,267,75,320,64C373.3,53,427,43,480,64C533.3,85,587,139,640,138.7C693.3,139,747,85,800,80C853.3,75,907,117,960,133.3C1013.3,149,1067,139,1120,165.3C1173.3,192,1227,256,1280,240C1333.3,224,1387,128,1413,80L1440,32L1440,320L1413.3,320C1386.7,320,1333,320,1280,320C1226.7,320,1173,320,1120,320C1066.7,320,1013,320,960,320C906.7,320,853,320,800,320C746.7,320,693,320,640,320C586.7,320,533,320,480,320C426.7,320,373,320,320,320C266.7,320,213,320,160,320C106.7,320,53,320,27,320L0,320Z"
      ></path>
    </svg>
    <div class="box-wrapper">
      ...
      <div class="bottom-box">
        <div class="column flex">
          <p class="copyright">© Collorizer by Eduardo Migueis</p>
        </div>
        <div class="column flex"><p>Made to spread colors.</p></div>
        <div class="column">
